...
-(void)buildHeaderView{
    ...
    _cateGoryButton = [[ZTButtonGridView alloc] initWithIcons:_category_source cell:@"ZTButtonCell" column:4 rowSpace:1.0 columnSpace:1.0 edgeSpace:1.0 version:nil];
