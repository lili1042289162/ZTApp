...
#define NET_ARG_TMQNO  @"tmqno"         //优惠劵
#define NET_ARG_TBMONEY @"tbmoney"      //tb金额
...
/////////////cartorder///////////////
//***************(api)*******************
#define NET_API_CARTORDER @"tmord/a/cartorder"  //从购物车付款
//*************(arg)*******************
#define NET_ARG_CARTORDER_ADDRID @"addrid"     //生成订单时地址id
#define NET_ARG_CARTORDER_SENDIDD @"sendm"           // 送货方式
#define NET_ARG_CARTORDER_INVOICE @"fapiao"            // 发票抬头
#define NET_ARG_CARTORDER_LNGO @"lngo"                   // 经度
#define NET_ARG_CARTORDER_LATO @"lato"                   //纬度
#define NET_ARG_CARTORDER_CTID @"ctid"              //购物车id
#define NET_ARG_CARTORDER_CTMESS @"ctmess"            //购物留言
#define NET_ARG_CARTORDER_TBJE @"tbmoney"            //tb金额
 #define NET_ARG_TMQNO_CARTORDER_TMQNO  @"tmqno"          //优惠劵号
...
////////////getmytmordmx///////////////////
//************(api)*****************
#define NET_GETMYTMORD_MX @"my/a/getmytmordmx"//特卖订单明细
//****************(ARG)*****************
#define NET_ARG_ORDZT_MX  @"ordzt"       //订单状态（0 待支付 1已支付）
#define  NET_ARG_DETAIL_ORDNO_MX   @"ordno"   //订单号
...
#define NET_ARG_ORDNO_ORDRECGOODS_ONOX  @"onox"        //   订单明细
/////////gettmrecm////////////////////////////////
////*************(api)***********************
...
///////////////gettmrecm//////////////////////
//************(api)***********************
#define NET_API_ORDRECCOM     @"tmord/a/ordreccom"   //发表特卖订单评价
//***************(arg)*************************
#define NET_ARG_ORDRECCOM_ORDNO @"ordno"           //ordno/订单号
#define NET_ARG_ORDRECCOM_SHOPID @"shopid"        // shopid/店铺ID
#define NET_ARG_ORDRECCOM_CPID @"cpid"           // cpid/商品ID
#define NET_ARG_ORDRECCOM_CPMC @"cpmc"          // cpmc/商品名称
#define NET_ARG_ORDRECCOM_LEVEL @"level"       // level/好中差评(2,1,0)
#define NET_ARG_ORDRECCOM_DFEN @"dfen"       // dfen/评分
#define NET_ARG_ORDRECCOM_MEMO @"memo"      // memo/评价内容
#define NET_ARG_ORDRECCOM_ONOX @"onox"     // onox/订单明细
...
/////////////////////veryzm////////////
//************(api)*******************        //校验验证码
#define NET_API_VERYZM @"user/a/veryzm"
#define NET_ARG_VERYZM_MOBILE @"mobile"          // 手机号码
#define NET_ARG__VERYZM_YZM @"yzm"             // 短信验证码
...
///////////////// addcart///////////////
//**************(API)******************
#define NET_API_ADDCART        @"tmord/a/addcart" //加入购物车
//*********(ARG)**********************
#define NET_ARG_ADDCART_TMID   @"tmid"   //商品id
#define NET_ARG_ADDCART_TMSL    @"tmsl"  //特卖数量
#define NET_ARG_ADDCART_CMID    @"cmid"  //尺码id
#define NET_ARG_ADDCART_BTIMES @"btimes"  //限购次数
#define NET_ARG_ADDCART_BNUMS   @"bnums"  //限购数量

///////////////////getcart//////////////////
//**************(api)***********************
#define NET_API_GETCAR        @"tmord/a/getcart"       //获取购物车

///////////////editcart/////////////////
//************(api)************************
#define NET_API_EDITCART      @"tmord/a/editcart"  //更新购物车
//**********(arg)*******************************
#define NET_ARG_EDITCART_CTID  @"ctid"       //购物车id
#define NET_ARG_EDITCART_TMSL  @"tmsl"     //数量


///////////////////delcart//////////////////////
//****************(api)***********************
#define NET_API_DELCART      @"tmord/a/delcart"    //删除购物车
//***********(arg)*****************************
#define NET_ARG_DELCART_CTID  @"ctid"         //购物车id

///////////////////ordcancel/////////////////
//*****************(api)********************
#define NET_API_ORDCANCEL      @"tmord/a/ordcancel"    //删除订单
//***********(arg)*****************************
#define NET_ARG_ORDCANCEL_ORDNO  @"ordno"            //订单id


//////////////////////gettmquan////////////////
//*****************(api)**********************
#define NET_API_GETTMQUAN   @"my/a/gettmquan"    //获取优惠劵
//**********(arg)*******************************
#define NET_ARG_GETTMQUAN_SHOPID  @"shopid"       //店铺id组合
#define NET_ARG_GETTMQUAN_ORDJE  @"ordje"     //店铺金额组合

///////////////ordtbmoney////////////////////
//******************(api)*******************
#define NET_API_ORDTBMONEY   @"tmord/a/ordtbmoney"    //下单使用团币
//**********(arg)*******************************
#define NET_ARG_ORDTBMONEY_TMID  @"tmid"       //商品id组合
