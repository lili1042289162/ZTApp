...
-(void)buildViews{
    ...
    _aboutTitle = [[ZTSessionTitle alloc] initWithTitle:@"有关『中团超市』的版权声明:"];
    ...
    _aboutContent.text = @"中团超市APP是由中团公司开发出得一款F2F手机购物APP,所有解释权归本公司所有.";
    ...
    _contactContent.text = @"深圳中团科技有限公司\n\n电话: 020-85584512\n\n传真: 020-85584512\n\n电子邮箱: 568984480@qq.com\n\n网址: www.ztchaoshi.com";
