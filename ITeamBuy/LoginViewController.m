...
//    setRectMarginBottom:15.0];
    ...
    [[[[[_registerButton fitSize]
       setRectMarginLeft:15.0]
      setRectWidth:94.5]
     setRectBelowOfView:_loginButton]addRectY:15.0];
...
-(void)buildViews{
   ...
   _topBanner.userInteractionEnabled=YES;
    ...
    _phoneInput.topBorder=YES;
    _phoneInput.lineColor=[UIColor redColor];
   ...
   // [_phoneInput setImageLabel:[UIImage imageNamed:@"lab_user"] withSeparator:[UIImage imageNamed:@"lab_separator"]];
    [_phoneInput setTextLabel:@"账号" withSeparator:nil];
    ...
    _paswInput.borderWidth = 0.5;
     _paswInput.lineColor=[UIColor redColor];
   ...
   [_paswInput setTextLabel:@"密码" withSeparator:nil];
    ...
    _registerButton = [[ZTRoundButton alloc] initWithTitle:@"立即注册"
            textcolor:[UIColor whiteColor] backgroundImage:[UIImage imageNamed:@"btn_bg_nomal"]];
    ...
    _coverView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"welcome"]];
     ...
     [_sv addSubViews:@[top,_phoneInput,_paswInput,_registerButton,_loginButton,_forgetButton]];
