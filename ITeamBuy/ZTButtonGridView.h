...
-(ZTButtonGridView*)initWithIcons:(NSDictionary*)iconNames cell:(NSString*)cellClassName column:(long)col rowSpace:(float)rowSpace columnSpace:(float)colSpace edgeSpace:(float)edgeSpace version:(NSString*)version;
