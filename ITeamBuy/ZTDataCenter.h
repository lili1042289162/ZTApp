...
-(NSArray*)getProductsFromPage:(NSInteger)page pageSize:(NSInteger)size offSet:(NSInteger)offset count:(NSInteger)count firstorderBy:(NSString*)at asic:(BOOL)asic secondorderBy:(NSString*)att asic:(BOOL)asicc thirdorderBy:(NSString*)attt asic:(BOOL)asiccc type:(NSString*)type;
